...
CurrentsGridDF <- GridDF <- readRDS("~/Albersnet/Iceberg Files/Climate1/Iceberg Output Files/CurrentsGridDF.rds") 
...
saveRDS(FitList, file = "Iceberg Output Files/FitList.rds")

saveRDS(FullDataDF, file = "Iceberg Output Files/FullDataDF.rds")

saveRDS(NEPredictModels, file = "Iceberg Output Files/NEGams.rds")
