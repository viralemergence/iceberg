...
for(x in 1:length(NewEncountersList)){
  ...
  NEGridList2[[PredReps[x+1]]] <- GridDF
...
for(i in 1:length(NEGridList2)) NEGridList2[[i]] <- NEGridList2[[i]][-Sea,]

save(NEGridList2, file = "Iceberg Output Files/NEGridList2.Rdata")
